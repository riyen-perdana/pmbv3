        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    />
                    <div class="mt-4">
                        <h5 class="mb-3">Apakah Anda Membatalkan Verifikasi ?</h5>
                        <p class="text-muted mb-4">Hanya Peserta Yang Bisa Melakukan Verifikasi Kembali</p>
                        <div class="hstack gap-2 justify-content-center">
                            ...
                            <button class="btn btn-danger" @click="destroy(props.id)">Batal</button>
                        </div>
                    </div>
                </div>
            </div>
...
const emit = defineEmits(['closeAlert','cancelVer'])
