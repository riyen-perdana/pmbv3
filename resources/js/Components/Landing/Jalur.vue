                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            <h3 class="mb-3 fw-bold text-uppercase">Jalur Masuk</h3>
                            <p class="text-muted mb-4">Jalur Masuk Universitas Islam Negeri Sultan Syarif Kasim Riau</p>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
                            ...
                            <div class="card-body p-4 m-2">
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <h5 class="mb-1 fw-bold">Undangan Mandiri</h5>
                                        <p class="text-muted mb-0">Seleksi Jalur Prestasi</p>
                                    </div>
                                    <div class="avatar-sm">
                                    ...
                                    <ul class="list-unstyled text-muted vstack gap-3">
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <b>Pradaftar</b><br> [15 Juni - 15 Juli 2024]
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <b>Pembayaran Pendaftaran</b><br> [15 Juni - 15 Juli 2024]
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <b>Pendaftaran</b><br> [15 Juni - 17 Juli 2024]
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <b>Verifikasi</b><br> [15 Juni - 17 Juli 2024]
                                                </div>
                                            </div>
                                        </li>
                                        <li>
