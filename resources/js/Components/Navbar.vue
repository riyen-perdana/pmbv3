            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <Link class="nav-link menu-link" href="#sidebarMD" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMD">
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <Link class="nav-link menu-link" href="/apps/permissions">
                                            <i class="bx bx-fingerprint"></i> <span data-key="t-permission">Permission</span>
                                        </Link>
                                    </li>
                                    <li class="nav-item">
                                        <Link class="nav-link menu-link" href="/apps/surat-masuk">
                                            <i class="bx bx-envelope"></i> <span data-key="t-permission">Surat Masuk</span>
                                        </Link>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="/apps/surat-keluar">
                                            <i class="bx bx-mail-send"></i> <span data-key="t-permission">Surat Keluar</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="/apps/dokumen">
                                            <i class="bx bxs-file-archive"></i> <span data-key="t-permission">Dokumen</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            <Link class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                                <i class="bx bx-lock"></i> <span data-key="t-sidebarAuth">Authentikasi</span>
                            </Link>
                        ...
                        <li class="nav-item">
                            <Link class="nav-link menu-link" href="#sidebarUnor" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarUnor">
                                <i class="bx bx-home"></i> <span data-key="t-sidebarAuth">Unit Organisasi</span>
                            </Link>
