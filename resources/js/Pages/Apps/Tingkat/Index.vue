                    ...
                    <div class="row mb-3 pb-1 p-3">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <div class="flex-grow-1">
                                <Titlebox :isDashboard="false" title="Data Tingkat Prestasi"
                                    subTitle="Manajemen Data Tingkat Prestasi Aplikasi E-Admisi" />
                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="search-box">
                                                <input type="text" class="form-control search bg-light"
                                                    placeholder="Cari Data tingkat Prestasi" v-model="data.params.search">
                                    ...
                                    <div class="row">
                                        <div>
                                            <div class="table-responsive table-card mb-3 mt-3">
                                                <table class="table table-hover align-middle table-nowrap mb-0"
                                                    ...
                                                    <thead class="table-light boder-white">
                                                        <tr>
                                                            ...
                                                            <th scope="col" style="width:20%;">Nama Tingkat Prestasi</th>
                                                            <th scope="col" style="width:60%;">Nilai</th>
                                                            <th scope="col" style="width: 13%;">Aksi</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr v-for="(tkt, index) in tingkat.data" :key="index">
                                                            <td class="r_atas">{{ (tingkat.current_page - 1) * data.params.perPage + index + 1 }}</td>
                                                            <td class="r-atas">{{ tkt.nama }}</td>
                                                            <td class="r_atas">{{ tkt.nilai }}</td>
                                                            <td class="r_atas">
                                                                <div class="hstack gap-2 flex-wrap">
                                                                    <!-- Buttons Group -->
                                                                    <button type="button"
                                                                        class="btn btn-secondary btn-sm"
                                                                        @click="clickButton(tkt.id, tkt)"><i
                                                                            class="ri-edit-2-line label-icon align-middle fs-10 me-1"></i>
                                                                        Edit&nbsp;&nbsp;&nbsp;</button>
                                                                    <button type="button" class="btn btn-danger btn-sm"
                                                                        @click="destroy(tkt.id)"><i
                                                ...
                                                <Emptytable :data="props.tingkat" />
                                            </div>
                                            <div v-if="tingkat.data.length != 0">
                                                <Pagination :links="tingkat.links" :count="tingkat" :perPage="props.perPage" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
import Form from "@/Pages/Apps/Tingkat/Form.vue";
...
const clickButton = (id, tingkat) => {
    data.id = id
    if (id == '') {
        data.isEdit = false
    } else {
        data.isEdit = true
        data.dataEdit = tingkat;
    }
